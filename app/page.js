  ...
  return (
    <div className="w-full h-[100vh] justify-center align-middle items-center flex">
      <div className="space-y-[1rem]">
        ...
        <div className="w-full flex justify-center">
          <p className="w-[70%] text-center">Hubungi CS Kami dengan klik tobol dibawah, kalau kamu butuh plafon PVC, wall panel WPC, lantai SPC, lantai vinyl, lis moulding, lis plint, dan masih banyak lagi</p>
        </div>
        <div className="w-full flex justify-center">
